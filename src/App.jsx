...
function App() {
  ...
  const cleanAltLabels = (altLabelsField) => {
    ...
    return cleaned.split(',').map(label => label.trim()).filter(label => label)
  }
      ...
      <div className="min-h-screen bg-gray-50 p-6">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-xl shadow-sm border p-8">
            ...
            {altLabels.length > 0 && (
              <div>
                <h2 className="text-xl font-semibold mb-3">Alternative Labels</h2>
    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-2xl mx-auto">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Search and explore professional occupations</p>
        </div>
              ...
              {results.map((skill, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="text-sm text-blue-600">{skill.OCCUPATIONTYPE || 'Occupation'}</div>
                    {skill.DESCRIPTION && (
